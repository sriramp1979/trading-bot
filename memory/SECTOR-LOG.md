...
|--------|-----------|--------|
| Communication Services | 2026-06-22 | 2 consecutive losses (META stop-out Jun 11, GOOGL thesis-break exit Jun 22 — dilution + FCF collapse + AI talent flight) — **reset to OK 2026-07-10** (2+ weeks elapsed, no new trades in sector) |
| Technology | 2026-06-25 | 2 consecutive losses (NVDA stop-out Jun 5, NVDA stop-out Jun 25 — Micron sell-the-news selloff dragged GPU names; chip sector multiple compression) — **reset to OK 2026-07-10** (2+ weeks elapsed, no new trades in sector) |
